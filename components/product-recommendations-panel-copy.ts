...
const baseProductRecommendationCopy = {
  en: {
    ...
    preferenceCompactHint: "Fewer products where dose fit allows",
    preferenceBalanced: "Balanced",
    preferenceBalancedHint: "Closest dose fit with explicit alternatives for simplicity and cost",
    preferenceUpdating: "Switching product stack...",
    refreshingAvailability: "Refreshing current store availability...",
  ...
  th: {
    ...
    preferenceCompactHint: "ลดจำนวนผลิตภัณฑ์เมื่อยังได้ปริมาณที่เหมาะสม",
    preferenceBalanced: "สมดุล",
    preferenceBalancedHint: "ปริมาณใกล้เป้าหมายที่สุด พร้อมทางเลือกด้านความง่ายและราคา",
    preferenceUpdating: "กำลังเปลี่ยนชุดสินค้า...",
    refreshingAvailability: "กำลังอัปเดตความพร้อมจำหน่ายล่าสุด...",
...
export const productRecommendationCopy = {
  ...
  "zh-CN": {
    ...
    preferenceCompactHint: "在剂量匹配允许时减少产品数量",
    preferenceBalanced: "均衡",
    preferenceBalancedHint: "优先选择最接近目标的剂量，并提供更简单、费用更低的选项",
    preferenceUpdating: "正在切换产品组合...",
    refreshingAvailability: "正在刷新当前门店库存...",

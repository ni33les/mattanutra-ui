...
const baseContent = {
  en: {
    ...
    contentPages: {
      ...
      locale: "Locale",
      newBlogPost: "New Library article",
    ...
    access: {
      ...
      save: "Save",
      sendRecoveryInvite: "Send recovery invite",
      session: "Session",
      slug: "Slug",
      status: "Status",
    ...
    contentNavigation: [
      { icon: DocumentTextIcon, name: "Library", view: "blogs" },
  ...
  th: {
    ...
    contentPages: {
      ...
      lastViewed: "ดูล่าสุด",
      locale: "ภาษา",
      newBlogPost: "บทความคลังความรู้ใหม่",
    ...
    access: {
      ...
      rotateKey: "หมุนคีย์",
      save: "บันทึก",
      sendRecoveryInvite: "ส่งคำเชิญกู้คืน",
      session: "เซสชัน",
      slug: "Slug",
      status: "สถานะ",

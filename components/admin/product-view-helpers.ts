...
export const productViewLabels = {
  en: {
    ...
    matchingProfile: "Matching profile",
    matchingProduct: "Product",
    matchingReadiness: "Matching readiness",
    matchingReady: "Ready",
    matchingValidation: "Validation",
    matcherDose: "Dose",
    matcherComparable: "Comparable",
    matcherItem: "Matcher item",
    matcherKey: "Key",
    matcherSource: "Source",
    matcherStatus: "Status",
    pendingReview: "Review",
    products: "Products",
    listUnavailable: "Product catalogue could not be loaded. Try again.",
    search: "Search",
    ...
    exportCatalogueOnly: "Catalogue only",
    exportIncludePrices: "Include wholesale and retail prices",
    exportFilterHint: "Exports the products currently shown by search and filters.",
    exportRetailer: "Retailer",
    ...
    servingsPerPackHint: "Optional. How many servings are in one pack. Leave blank if unknown.",
    ...
    stateIgnored: "Withdrawn",
    statePendingReview: "Review",
  ...
  th: {
    ...
    matchingProfile: "โปรไฟล์การจับคู่",
    matchingProduct: "สินค้า",
    matchingReadiness: "ความพร้อมในการจับคู่",
    matchingReady: "พร้อม",
    matchingValidation: "การตรวจสอบ",
    matcherDose: "ปริมาณ",
    matcherComparable: "เทียบเท่า",
    matcherItem: "รายการจับคู่",
    matcherKey: "คีย์",
    matcherSource: "แหล่งข้อมูล",
    matcherStatus: "สถานะ",
    pendingReview: "รอตรวจสอบ",
    products: "สินค้า",
    listUnavailable: "โหลดรายการสินค้าไม่สำเร็จ โปรดลองอีกครั้ง",
    search: "ค้นหา",
    ...
    exportCatalogueOnly: "เฉพาะแคตตาล็อก",
    exportIncludePrices: "รวมราคาขายส่งและราคาขายปลีก",
    exportFilterHint: "ส่งออกสินค้าที่แสดงจากการค้นหาและตัวกรองปัจจุบัน",
    exportRetailer: "ร้านค้า",
    ...
    servingsPerPack: "จำนวนหน่วยบริโภคต่อบรรจุภัณฑ์",
    servingsPerPackHint: "ไม่บังคับ จำนวนหน่วยบริโภคในหนึ่งบรรจุภัณฑ์ เว้นว่างได้ถ้ายังไม่ทราบ",
  ...
  "zh-CN": {
    ...
    ean13: "EAN-13 条码",
    exportCsv: "导出 CSV",
    exportCatalogueOnly: "仅目录",
    exportIncludePrices: "包含批发价和零售价",
    exportFilterHint: "导出当前搜索和筛选结果中的产品。",
    exportRetailer: "零售商",
    exportDownload: "下载",
    exportJson: "导出 JSON",
    ...
    parsedFacts: "已解析资料",
    servingsPerPack: "每包装份数",
    servingsPerPackHint: "可选。一包装有多少份。不知道可留空。",

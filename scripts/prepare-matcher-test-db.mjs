...
try {
  ...
  for (const script of ['apply-locale-schema', 'apply-product-administration-schema', 'apply-agentic-commerce-schema', 'apply-web-funnel-schema', 'apply-matcher-v5-runtime-schema', 'apply-service-efficiency-schema', 'apply-retail-checkout-schema', 'apply-payment-schema']) {

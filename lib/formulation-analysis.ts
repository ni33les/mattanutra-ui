...
>) {
  const prompt = {
      ...
      instructions: [
        ...
        "Recommend only justified ingredients from canonicalSupplementCatalogue, the complete approved ingredient list independent of retail product availability. Return an empty supplementBreakdown if none fits. Never pad or add unlisted ingredients.",
        ...
        "Keep ingredients operationally available with status=add or covered despite clinical concerns. Add a linked caution for medication, pregnancy, breastfeeding, conditions, limits, or uncertainty; never describe a match as medically approved.",

  ...
  return JSON.stringify(
    {
      ...
      instructions: [
        ...
        "supplementBreakdown should contain the assessment-justified number of items, usually 6 to 12.",
        "Choose the right number of supplements for this assessment. Do not pad to a fixed count.",

...
const METRIC_NAMES = ["mcp.stream_wait_ms", "mcp.stream.result", "mcp.stream.processing", "mcp.stream.disconnected", "mcp.stream.read_failed", "mcp.admission_ms", "mcp.retrieval_ms", "match.catalogue_ms", "match.compilation_ms", "match.search_ms", "match.publication_ms", "db.acquire_begin_ms", "db.setup_ms", "db.sql_ms", "db.statements", "db.lock_timeouts", "db.lock_statement_client_ms", "db.transaction_client_ms",

...
export const webMatchingCopy = {
  en: { evidence: "Evidence", retry: "Retry alternative search", advice: "Health advice", alternatives: "Other options", none: "No distinct option with fewer concerns was found within these requirements.", incomplete: "The alternative search is incomplete. You can retry it.", coverage: "Coverage", pills: "Estimated daily pill count", subtotal: "Product subtotal; delivery calculated at checkout", choose: "Confirm this option", replan: "Exclude removed products and replan", clear: "Clear product exclusions and replan", error: "Replanning failed. Please retry." },
  th: { evidence: "หลักฐาน", retry: "ลองค้นหาตัวเลือกอื่นอีกครั้ง", advice: "คำแนะนำด้านสุขภาพ", alternatives: "ตัวเลือกอื่น", none: "ไม่พบตัวเลือกที่แตกต่างและมีข้อควรระวังน้อยกว่าภายใต้ข้อกำหนดเหล่านี้", incomplete: "การค้นหาตัวเลือกอื่นยังไม่เสร็จสมบูรณ์ คุณลองใหม่ได้", coverage: "ความครอบคลุม", pills: "จำนวนเม็ดต่อวันโดยประมาณ", subtotal: "ราคารวมสินค้า คำนวณค่าจัดส่งเมื่อชำระเงิน", choose: "ยืนยันตัวเลือกนี้", replan: "ยกเว้นสินค้าที่นำออกและจัดแผนใหม่", clear: "ล้างรายการยกเว้นสินค้าและจัดแผนใหม่", error: "จัดแผนใหม่ไม่สำเร็จ โปรดลองอีกครั้ง" },
  "zh-CN": { evidence: "依据", retry: "重试其他选项搜索", advice: "健康建议", alternatives: "其他选项", none: "在这些要求内，未找到注意事项更少的不同选项。", incomplete: "其他选项的搜索尚未完成，您可以重试。", coverage: "覆盖率", pills: "估计每日粒数", subtotal: "商品小计；运费在结账时计算", choose: "确认此选项", replan: "排除已移除的商品并重新规划", clear: "清除商品排除项并重新规划", error: "重新规划失败，请重试。" }
} as const;

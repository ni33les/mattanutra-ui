...
export const PLAN_REQUEST = object({
  ...
  conditionCodes: optional({ ...strings(), description: "Reported condition codes from info.conditionCodes; accepted inputs do not establish assessed interaction coverage." }), medicationCodes: optional({ ...strings(), description: "Medication codes from info.medicationCodes; omission means unknown, not confirmed none." }),

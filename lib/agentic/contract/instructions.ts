...
export const AGENTIC_TOOL_DESCRIPTIONS = {
  ...
  plan: `${READY_MEANING} Create/get/revise/answer/select; conversation default. get: status + knownResultVersion, or details + sections + expectedRevision (optionIds optional). requestPatch preserves context. Counts and health findings are advice; exclusions and physical quantities bind. Expanded adds attempts, not looser rules.`,

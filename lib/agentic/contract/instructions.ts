...
export const AGENTIC_TOOL_DESCRIPTIONS = {
  info: "Service card + contract. Call first: view=overview | client_guide | plan_schema (choose planOperation).",
  plan: "Create/get/revise/answer/select; conversation default. get: status + knownResultVersion, or details + sections + expectedRevision (optionIds optional). requestPatch preserves context. Expanded adds attempts, not looser rules.",

...
import { connectorCopy, connectorInfoDescription } from "@/lib/agentic/discovery/content";
...
export const AGENTIC_TOOL_DESCRIPTIONS = {
  ...
  info: connectorInfoDescription("en"),
  order:
...
export function agenticToolDescriptions(
  ...
  return {
    ...base,
    ...(environment === "dev" ? { info: connectorCopy(locale) } : {})
  };
}

...
export const CLIENT_EXAMPLES = [
  ...
  { name: "confirm-recommendation", tool: "plan", arguments: { ...controls, selectedOptionId: "opt_replace_with_returned_option" } },

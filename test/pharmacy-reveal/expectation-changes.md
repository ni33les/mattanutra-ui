...
- Pharmacy landing now opens the first question directly; the shared HealthScore welcome remains exclusive to ordinary web entry. PHARM-BROWSER exercises the first answer, reload/continue and explicit restart in each locale, and preserves the ordinary web welcome/start check. Session URLs, the pharmacy progress/reveal handoff, receipt recovery, and fixture prices remain unchanged. RED evidence against build 10411751 is preserved at /root/pharmacy-direct-quiz-evidence/red.

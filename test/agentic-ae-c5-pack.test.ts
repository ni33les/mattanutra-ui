...
if (process.env.NODE_TEST_CONTEXT) {
  describe("agentic experience cycle 5 pack", () => {
    it("exports 7 cases and a canonical report", async () => {
      ...
      assertRecordedMcpEvidence(report, "AE C5 pack");
      assert.deepEqual(report.cases.find(item => item.id === "AX5-07")?.evidence.mcpTranscript, {
        version: 1,
        calls: []
      });

...
test("ADV6-PLAN-02 retention preserves identity without imposing an exact target-dose requirement", () => {
  const state: CanonicalPlanState = { acceptedGaps: [], conditionCodes: [], currency: "THB", currentSupplements: [{ name: "A", supplementId: "a", dailyAmount: 10, unit: "mg", productId: "continued" }], destinationCountry: "TH", leftovers: [], locale: "en", medicationCodes: [], optimization: "balanced", pinnedCandidateKey: null, profile: { ageYears: 35, lifeStage: "adult" }, requirements: { retainProductIds: ["continued"], retainSupplementIds: ["a"] }, safetyAcknowledgement: null, targets: [{ name: "A", supplementId: "a", amount: 100, unit: "mg" }] };
